...
use ljc\Api\Settings;
use ljc\Api\Callbacks\SettingsCallback;
...
class Admin
{
	...
	private function pages()
	{
		$admin_pages = array(
			array(
				'page_title' => 'ljc Admin Page',
				'menu_title' => 'ljc',
				'capability' => 'manage_options',
				'menu_slug' => 'ljc',
				'callback' => array( $this->callback, 'admin_index' ),
				'icon_url' => get_template_directory_uri() . '/assets/images/ljc-logo.png',
				'position' => 110,
			)
		);
	...
	private function settings()
	{
		...
		$args = array(
			array(
				'option_group' => 'ljc_options_group',
				'option_name' => 'first_name',
				'callback' => array( $this->callback, 'ljc_options_group' )
			),
			array(
				'option_group' => 'ljc_options_group',
				'option_name' => 'ljc_test2'
			)
		);
	...
	private function sections()
	{
		...
		$args = array(
			array(
				'id' => 'ljc_admin_index',
				'title' => 'Settings',
				'callback' => array( $this->callback, 'ljc_admin_index' ),
				'page' => 'ljc'
			)
		);
